...
- Compensate for missing or unreliable information in any single .secondary[omics] data
...
**Omics** is the comprehensive study of all moluecules of particular type.

- Each .secondary[omics] data follow $N \times P$ structure
...
![](materials/img/multi-omics.png)

]

.pull-right[

![](materials/img/types-methods.png)
...
DT::datatable(
  ...
  DT::formatStyle(columns = colnames(data_tab), fontSize = '68%')
```
