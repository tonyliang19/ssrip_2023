...
.pull-left-narrow[
.secondary[Curate multi-omics data from open-source databases
]
...
.pull-right-wide[
.secondary[ `Benchmarking` integrative multi-omics methods
]

- Evaluate series of methods based on their tasks with classic metrics

- Compare methods on different types of multi-omics data
...
- Availability of list of curated multi-omics dataset
